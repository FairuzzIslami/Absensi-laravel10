                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="jurusan" class="form-select" required>
                                    ...
                                    <option value="animasi" {{ old('jurusan') == 'animasi' ? 'selected' : '' }}>Animasi
                                    </option>
                                    ...
                                    <option value="farmasi" {{ old('jurusan') == 'farmasi' ? 'selected' : '' }}>Farmasi
                                    </option>
                                    <option value="tmi" {{ old('jurusan') == 'tmi' ? 'selected' : '' }}>TMI</option>
                                    <option value="tataboga" {{ old('jurusan') == 'tataboga' ? 'selected' : '' }}>Tataboga
                                    </option>
                                </select>
                            </div>
                        </div>

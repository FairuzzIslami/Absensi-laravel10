                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        ...
                        @if ($user->role->nama_role === 'admin')
                            <p class="mt-2"><strong>Hak Akses:</strong> Mengelola seluruh sistem (User, Kelas, Kehadiran,
                                dll).</p>
                        ...
                        @elseif ($user->role->nama_role === 'siswa')
                            ...
                            <p class="mt-1"><strong>Jurusan:</strong> {{ $user->kelas->jurusan ?? 'Belum ditentukan' }}
                            </p>
                        @endif

    ...
    <div class="container my-4">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h4 class="card-title fw-bold">Detail Kegiatan</h4>
                    </div>
            ...
            <div class="card-body">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td> : </td>
                        <td>
                            {{ date('D F Y', strtotime($data->tgl_kegiatan)) }}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td> : </td>
                        <td>
                            {{ date('H:i', strtotime($data->waktu_kegiatan)) }}
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table class="table table-striped" id="">
                    ...
                    <tbody>
                        @if ($kehadiranDetail->isempty())
                            <tr>
                                <td colspan = "5" class="text-center">Belum Ada Data</td>
                            </tr>
                        @endif
                        @foreach ($kehadiranDetail as $detail)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('kehadiran-detail.destroy', $item->id) }}" method="POST"
                                        class="d-inline">
                                        @method('DELETE')
                                        @csrf
